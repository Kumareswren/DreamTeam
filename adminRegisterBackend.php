...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($component === 'adminRegister') {
        ...
        if (containsSymbols($firstName) || containsSymbols($lastName)) {
            echo "First name and last name cannot contain symbols.";
            exit();
        }
...
if ($userType === 'student') {
        ...
        if ($stmt->execute()) {
            // Registration successful, perform additional actions
...
$full_user_agent, $matches)) {
        ...
        // Invalid component or form submission
        echo "Invalid form submission";
        exit();
    }
}

// Function to check if string contains symbols
