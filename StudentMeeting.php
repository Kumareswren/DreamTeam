...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card shadow">
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="form" name="studentMeetingForm" onsubmit="return validateForm()" id="studentMeetingForm">
                        ...
                        <button type="submit" id="submitButton" class="btn btn-primary btn-action">Request Meeting</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    document.getElementById("studentMeetingForm").addEventListener("submit", function() {
